...
do
    ...
    do
        ...
        then
            ...
            if (($(bc <<< "scale=6; $PerformanceMj > $PerformanceMmax")))
            then
    ...
    do
        ...
        then
            ...
            if (($(bc <<< "scale=6; $PerformanceNj > $PerformanceNmax")))
            then
    ...
    do
        ...
        then
            ...
            if (($(bc <<< "scale=6; $PerformanceKj > $PerformanceKmax")))
            then
    ...
    if (($(bc <<< "scale=6; $PerformanceN < 1")))
    then
        PerformanceN="0"$PerformanceN
    fi
    if (($(bc <<< "scale=6; $PerformanceK < 1")))
    then
        PerformanceK="0"$PerformanceK
    fi
    if (($(bc <<< "scale=6; $PerformanceMmax < 1")))
    then
        PerformanceMmax="0"$PerformanceMmax
    fi
    if (($(bc <<< "scale=6; $PerformanceNmax < 1")))
    then
        PerformanceNmax="0"$PerformanceNmax
    fi
    if (($(bc <<< "scale=6; $PerformanceKmax < 1")))
    then
