...
int MatrixMulTime(int func, 
    ...
    switch (func) {
        ...
        case (FuncAsmMatrixMulParallelV6N):
            ...
            //     blockSizeK = p2(6);
            // }
            blockSizeM = p2(7);//p2(3);//p2(5);// min p2(3)
            blockSizeN = p2(5);//(blockSizeN < threadsNum * threadsNum) ? 8 : p2(5);//p2(4);// min p2(3)
            blockSizeK = p2(9);//(blockSizeK < threadsNum * threadsNum) ? 8 : p2(6);//p2(5);// min p2(3)

            blockSizeM = p2(3);//p2(5);// min p2(3)
            blockSizeN = (blockSizeN < threadsNum * threadsNum) ? 8 : p2(6);//p2(4);// min p2(3)
