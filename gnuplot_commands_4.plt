...
plot "results.csv" using 1:2 with lines lt rgb "red" title columnhead, \
     ...
     "results.csv" using 1:5 with lines lt rgb "red" dt 2 title columnhead, \
     "results.csv" using 1:6 with lines lt rgb "#009900" dt 2 title columnhead, \
     "results.csv" using 1:7 with lines lt rgb "blue" dt 2 title columnhead
pause -1